...
__decorate([
    ...
    (0, class_validator_1.Length)(6, 72, { message: 'Email must be between 8 and 72 characters' }),
...
__decorate([
    (0, class_validator_1.IsString)({ message: 'Password must be a string' }),
    (0, class_validator_1.Length)(3, 32, { message: 'Nick name must be between 3 and 32 characters' }),
    __metadata("design:type", String)
