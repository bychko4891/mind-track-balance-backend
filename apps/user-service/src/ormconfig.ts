...
const port = Number(must('DB_PORT'));             // порт — число
const username = must('DB_USERNAME_USER');        // зверни увагу на суфікс _USER
const password = must('DB_PASSWORD_USER');        // ← ось тут був undefined
const database = must('DB_NAME_USER');
